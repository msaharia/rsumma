...
summaout <- nc_open('data_raw/cheyennecopy/PNW3L3H_2015-01-01-00_spinup_G09601-09650_1.nc') #Open the SUMMA output NetCDF file
...
sumdata_all <- data.frame(stime, pptrate, airtemp, scalarSurfaceRunoff, scalarSoilDrainage,
                          mLayerVolFracWat_soil, check.names=FALSE)
# return(sumdata_all)
